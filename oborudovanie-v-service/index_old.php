				...
				<div class="banks-selector">
					...
					<div class="period-selectors-wrapper" id="bank-periods">
						<div class="col col-1">
							...
							<div class="date-selector-wrapper"><input type="text" name="DATE_FROM" id="date-pick-1" value="<?=date('d.m.Y')?>"><button></button></div>
						</div>
						<div class="col col-2">
							<div class="lbl">Дата отгрузки от</div>
							<div class="date-selector-wrapper"><input type="text" name="DATE_TO" id="date-pick-2" value="<?=date('d.m.Y')?>"><button></button></div>
						</div>
						<div class="col col-3">
